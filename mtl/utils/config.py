...
def command_line_parser():
    ...
    parser.add_argument(
        '--resume', type=str, default=None, help='Resume training from checkpoint, which can also be an AWS link s3://...')
    ...
    # Before changing the default values here, remember that they should be changed in aws_train.sh
    parser.add_argument(
    ...
    parser.add_argument(
        '--model_name', type=str, default='deeplabv3p', choices=['deeplabv3p', 'branched', 'attention'], help='CNN architecture')
    parser.add_argument(
